...
export const dictionary = {
  ...
  "common.done": { vi: "Hoàn tất", en: "Done" },
  "common.loading": { vi: "Đang tải…", en: "Loading…" },
  "accounts.wizard.step.detect": { vi: "Bước: Phát hiện", en: "Step: Detect" },
  "accounts.wizard.step.select": { vi: "Bước: Chọn", en: "Step: Select" },
  "accounts.wizard.step.preview": { vi: "Bước: Xem trước", en: "Step: Preview" },
  "accounts.wizard.step.confirm": { vi: "Bước: Xác nhận", en: "Step: Confirm" },
  "accounts.wizard.step.provisioning": { vi: "Bước: Đang khởi tạo", en: "Step: Provisioning" },
  "accounts.wizard.step.ready": { vi: "Bước: Sẵn sàng", en: "Step: Ready" },
  "accounts.wizard.detect_desc": {
    vi: "Quét terminal cục bộ để tìm phiên MT4/MT5 đang chạy.",
    en: "Scan local terminals for running MT4/MT5 sessions.",
  },
  "accounts.wizard.run_detect": { vi: "Chạy phát hiện", en: "Run detection" },
  "accounts.wizard.select_desc": {
    vi: "Chọn terminal để đưa vào Panel.",
    en: "Select a terminal to onboard into the Panel.",
  },
  "accounts.wizard.preview_desc": {
    vi: "Xem trước payload sẽ gửi tới backend.",
    en: "Preview the payload that will be sent to the backend.",
  },
  "accounts.wizard.confirm_desc": {
    vi: "Xác nhận để mô phỏng thao tác (backend chưa kết nối).",
    en: "Confirm to simulate the action (backend not connected).",
  },
  "accounts.wizard.simulate_submit": { vi: "Mô phỏng gửi", en: "Simulate submit" },
  "accounts.wizard.provisioning": {
    vi: "Đang khởi tạo tài khoản…",
    en: "Provisioning account…",
  },
  "accounts.wizard.ready": { vi: "Tài khoản đã ở trạng thái", en: "Account is now" },
  "accounts.wizard.ready_note": {
    vi: "Tài khoản mới luôn bắt đầu ở READY_PAUSED — kích hoạt qua Hermes hoặc Lifecycle.",
    en: "New accounts always start READY_PAUSED — activate via Hermes or Lifecycle.",
  },
  "accounts.lifecycle.resume": { vi: "Tiếp tục", en: "Resume" },
  "accounts.lifecycle.activate": { vi: "Kích hoạt", en: "Activate" },
  "accounts.lifecycle.pause": { vi: "Tạm dừng", en: "Pause" },
  "accounts.lifecycle.drain_then_pause": { vi: "Xả rồi tạm dừng", en: "Drain then pause" },
  "accounts.lifecycle.reconcile": { vi: "Đối soát", en: "Reconcile" },
  "accounts.lifecycle.verify_identity": { vi: "Xác minh danh tính", en: "Verify identity" },
